						...
						<div class="panel panel-body" style="margin-bottom: 0px;">
							...
							<div style="text-align: center; margin-top: 12px" id="boton_nuevo">
								<?php if($_SESSION['tipo_corpoteg'] == 1){ ?>
									<button id="nuevo" type="button" class="btn btn-info" style="width:40%;text-align:center; color: white;" onclick="window.location.replace('nuevo_cliente.php')"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Nuevo cliente</button>
									<br>
									<br>
								<?php }?>

						...
						<div class="panel panel-body" style="margin-bottom: 0px;">
							...
							<div style="text-align: center; margin-top: 12px" id="boton_nuevo">
								<?php if($_SESSION['tipo_corpoteg'] == 1){ ?>
									<button id="nuevo" type="button" class="btn btn-info" style="width:40%;text-align:center; color: white;" onclick="window.location.replace('nueva_pregunta.php')"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Nueva pregunta</button>
									<br>
									<br>
								<?php }?>
							...
							<table class="table table-bordered"style="margin: 20px auto;width:80%;" id="cliente" name="cliente">
								<thead >
								  <tr class="info">
									...
									<th style="width:60%;text-align: center;">Tipo</th>
